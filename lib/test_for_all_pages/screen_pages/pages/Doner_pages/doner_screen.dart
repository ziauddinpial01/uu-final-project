...
import 'package:blood_app/test_for_all_pages/screen_pages/pages/Doner_pages/doner_models.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';

class Blood_Donner_page extends StatefulWidget {
  const Blood_Donner_page({Key? key}) : super(key: key);

  @override
  State<Blood_Donner_page> createState() => _Blood_Donner_pageState();
}

class _Blood_Donner_pageState extends State<Blood_Donner_page> {
  String? valueChoose1;
  String? valueChoose2;
  String? valueChoose3;
